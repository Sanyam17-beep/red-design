...
const About = () => {
  ...
  return (
    ...
    <h3 style={{color:"black",fontSize:"36px", textAlign:"center", display:"inline", position:"relative",marginLeft:"auto",marginRight:"auto"}}>Get to know us</h3>
        ...
        <div className='About-page-section to'>
        <div className='About-page-section-data'>
         <div className="para-wrapper">
            ...
            <div className='About-page-section-image topp'></div>
        </div>
        <h3 style={{color:"black",fontSize:"36px", textAlign:"center", display:"inline", position:"relative",marginLeft:"auto",marginRight:"auto"}}>Exemplary Interior Designers
</h3>
        <div className='About-page-section bo'>
            
        <div className='About-page-section-image bot'></div>
        <div className='About-page-section-data'>
                ...
                <div className="right-side">
                    <div className="image-frame" id="ex1">
                        <div id="ex1-layer" className="img-animation">
                            <img  src='https://adamdesignstudio.com/wp-content/uploads/2023/11/dl.beatsnoop.com-low-62cd5a2d38a75a21c0-1.jpg' height={500} width={800}></img>
                        </div>
